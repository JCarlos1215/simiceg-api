...
exports.generatePlanoCertificateManzanaBigDocumentDefinition = void 0;
const mm2inches = (mm) => mm / 25.4;
const inches2pixel = (inches) => Math.round(inches * 72);
const mm2pixel = (mm) => inches2pixel(mm2inches(mm));
exports.generatePlanoCertificateManzanaBigDocumentDefinition = (data) => {
    const dd = {
                                        ...
                                        [
                                            {
                                                table: {
                                                    ...
                                                    body: [
                                                        ...
                                                        [
                                                            {
                                                                text: `${data.PLANO_CERTIFICATE.estado}`,
                                                                style: ['Cuadro', 'Contenido'],
                                                                border: [false, false, false, false],
                                                            },
                                                            {
                                                                text: `${data.PLANO_CERTIFICATE.region}`,
                                                                style: ['Cuadro', 'Contenido'],
                                                                border: [false, false, false, false],
                                                            },
                                                            {
                                                                text: `${data.PLANO_CERTIFICATE.municipio}`,
                                                                style: ['Cuadro', 'Contenido'],
                                                                border: [false, false, false, false],
                                                            },
                                                            {
                                                                text: `${data.PLANO_CERTIFICATE.zona}`,
                                                                style: ['Cuadro', 'Contenido'],
                                                                border: [false, false, false, false],
                                                            },
                                                            {
                                                                text: `${data.PLANO_CERTIFICATE.localidad}`,
                                                                style: ['Cuadro', 'Contenido'],
                                                                border: [false, false, false, false],
                                                            },
                                                            {
                                                                text: `${data.PLANO_CERTIFICATE.sector}`,
                                                                style: ['Cuadro', 'Contenido'],
                                                                border: [false, false, false, false],
                                                            },
                                                            {
                                                                text: `${data.PLANO_CERTIFICATE.manzana}`,
                                                                style: ['Cuadro', 'Contenido'],
                                                                border: [false, false, false, false],
                                                            },
                                                        ],
...
const getMainWidths = (size) => {
    ...
    switch (size) {
        case '60':
            widths = [mm2pixel(457), mm2pixel(127)];
            break;
        case '90':
            widths = [mm2pixel(757), mm2pixel(127)];
            break;
        default:
            widths = [mm2pixel(457), mm2pixel(127)];
            break;
...
const getCroquisSectionWidths = (size) => {
    ...
    switch (size) {
        case '60':
            widths = [mm2pixel(454), mm2pixel(10)];
            break;
        case '90':
            widths = [mm2pixel(754), mm2pixel(10)];
            break;
        default:
            widths = [mm2pixel(454), mm2pixel(10)];
            break;
...
//# sourceMappingURL=plano-certificado-manzana-big.js.map