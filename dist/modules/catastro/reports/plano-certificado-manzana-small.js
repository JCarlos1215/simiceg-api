...
exports.generatePlanoCertificateManzanaSmallDocumentDefinition = void 0;
const mm2inches = (mm) => mm / 25.4;
const inches2pixel = (inches) => Math.round(inches * 72);
const mm2pixel = (mm) => inches2pixel(mm2inches(mm));
exports.generatePlanoCertificateManzanaSmallDocumentDefinition = (data) => {
    const dd = {
...
const getTableNormalizedClaveWidths = (size) => {
    ...
    switch (size) {
        case 'carta':
            widths = [mm2pixel(8), mm2pixel(8), mm2pixel(8), mm2pixel(8), mm2pixel(8), mm2pixel(8), mm2pixel(8)];
            break;
        case 'oficio':
            widths = [mm2pixel(8), mm2pixel(8), mm2pixel(8), mm2pixel(8), mm2pixel(8), mm2pixel(8), mm2pixel(8)];
            break;
...
//# sourceMappingURL=plano-certificado-manzana-small.js.map