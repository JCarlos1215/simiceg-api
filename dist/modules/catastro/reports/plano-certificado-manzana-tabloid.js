...
exports.generatePlanoCertificateManzanaTabloidDocumentDefinition = void 0;
const mm2inches = (mm) => mm / 25.4;
const inches2pixel = (inches) => Math.round(inches * 72);
const mm2pixel = (mm) => inches2pixel(mm2inches(mm));
exports.generatePlanoCertificateManzanaTabloidDocumentDefinition = (data) => {
    const dd = {
        pageSize: 'TABLOID',
...
//# sourceMappingURL=plano-certificado-manzana-tabloid.js.map